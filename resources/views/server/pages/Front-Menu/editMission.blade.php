                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table border="1" style="margin-bottom:30px; max-width:100%;" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr>
                                        <td>
                                            <textarea class="content" name="mission" id="description" cols="50" rows="10" data-validation="required" data-validation-error-msg="Content is required">{{$aboutData->mission}}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
